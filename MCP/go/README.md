# Klarna Payments API V1 MCP Server

This MCP (Model Content Protocol) server provides access to Klarna Payments API V1 API functionality through HTTP, HTTPS, and STDIO transport modes.
